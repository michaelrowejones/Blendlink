...
COMPONENT_DEFINITIONS = {
    ...
    "blendlink.chromatic-aberration": {
        ...
        "adapters": {"webgl": "preview", "tsl": "unavailable"},
        "fallbacks": {
            "tsl": "Use the WebGL chromatic-aberration adapter or disable the effect explicitly.",
        },
        "targets": {"SCENE"},
        "fields": (
    ...
    "blendlink.sharpen": {
        ...
        "adapters": {"webgl": "preview", "tsl": "unavailable"},
        "fallbacks": {
            "tsl": "Use the WebGL contrast-adaptive sharpen adapter or disable it explicitly.",
        },
        "targets": {"SCENE"},
    ...
    "blendlink.ambient-occlusion": {
        ...
        "adapters": {"webgl": "preview", "tsl": "unavailable"},
        "fallbacks": {
            "tsl": "Use the WebGL N8AO adapter or disable Ambient Occlusion explicitly.",
        },
        "targets": {"SCENE"},
        "fields": (
    ...
    "blendlink.depth-of-field": {
        ...
        "conflicts": (), "cost_level": "high",
        "adapters": {"webgl": "preview", "tsl": "unavailable"},
        "fallbacks": {"tsl": "Use the WebGL depth-of-field adapter or disable it explicitly."},
        "targets": {"SCENE"},
        "fields": (
