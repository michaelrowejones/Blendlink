...
| Node support | The package declares `^22.15.0 || ^24.0.0`; the workflow defines exact 22.15, latest 22, and latest 24 jobs. | **Implemented and hosted verified.** Run 30209329834 exposed the false 22.12 floor; corrective run 30210370073 passed all three jobs through exact packed-consumer evaluation on 2026-07-26. |
